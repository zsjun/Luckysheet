...
const menuButton = {
  ...
  focus: function($obj, value) {
    ...
    if (value == null) {
      ...
      $obj
        .find(".luckysheet-cols-menuitem[itemvalue='" + value + "']")
        .find("span.icon")
        .html('<i class="fa fa-check luckysheet-mousedown-cancel"></i>');
    }
  },
  ...
  initialMenuButton: function() {
    ...
    $("#luckysheet-icon-paintformat").click(function(e) {
      ...
      for (
        ...
        r <= Store.luckysheet_select_save[0].row[1];
        r++
      ) {
        if (
      ...
      .click(function() {
        ...
        if ($menuButton.length == 0) {
          ...
          $("#" + menuButtonId)
            ...
            .spectrum({
              ...
              change: function(color) {
                ...
                // 下边框换成了一个DIV
                $("#luckysheet-icon-text-color .text-color-bar").css(
                  "background-color",
                  color
                );
          ...
          $menuButton.find(".luckysheet-color-reset").click(function() {
            ...
            let $input = $("#" + menuButtonId).find(
              ".luckysheet-color-selected"
            );
            $input.val("#000000");
            $("#luckysheet-icon-text-color").attr("color", null);
            $input.spectrum("set", "#000000");
            $(
              "#luckysheet-icon-text-color .luckysheet-color-menu-button-indicator"
          ...
          //交替颜色
          $menuButton
            .find(".luckysheet-icon-alternateformat")
            .click(function() {
              $menuButton.hide();
              luckysheetContainerFocus();
    ...
    $("#luckysheet-icon-cell-color-menu").click(function() {
      ...
      if ($menuButton.length == 0) {
        ...
        $("#" + menuButtonId)
          ...
          .spectrum({
            ...
            change: function(color) {
              ...
              // 下边框换成了一个DIV
              $("#luckysheet-icon-cell-color .text-color-bar").css(
                "background-color",
                color
              );
        ...
        $menuButton.find(".luckysheet-color-reset").click(function() {
          ...
          $(
            "#luckysheet-icon-cell-color .luckysheet-color-menu-button-indicator"
          ).css("border-bottom-color", "#ffffff");
    ...
    $("#luckysheet-icon-border-all").click(function() {
      ...
      server.saveParam("cg", Store.currentSheetIndex, cfg["borderInfo"], {
        k: "borderInfo",
      });
    ...
    $("#luckysheet-icon-border-menu").click(function() {
      ...
      if ($menuButton.length == 0) {
        ...
        $menuButton.find(".luckysheet-cols-menuitem").click(function() {
          ...
          let $icon = $("#luckysheet-icon-border-all").find(
        ...
        $("#" + subcolormenuid)
          ...
          .spectrum({
            ...
            change: function(color) {
              ...
              let oldcolor = null;
              $("#luckysheet-icon-borderColor-linecolor").css(
                "border-bottom-color",
                color
              );
              $("#" + subcolormenuid)
      ...
      if ($menuButton.length == 0) {
        ...
        $menuButton.find(".luckysheet-cols-menuitem").click(function() {
          ...
          if (itemvalue == "freezenRow") {
            ...
            let row_st = luckysheet_searcharray(
            ...
            let col_st = luckysheet_searcharray(
            ...
            let row_focus =
              last["row_focus"] == null ? last["row"][0] : last["row_focus"];
        ...
        let itemdata = [
          {
            ...
            value: "asc",
            example:
              '<i class="iconfont luckysheet-iconfont-shengxu" aria-hidden="true"></i>',
          },
          {
            text: locale_sort.desc,
            value: "desc",
            example:
              '<i class="iconfont luckysheet-iconfont-jiangxu" aria-hidden="true"></i>',
          },
          {
            text: locale_sort.custom + "...",
            value: "diysort",
            example:
              '<i class="iconfont luckysheet-iconfont-zidingyipaixu" aria-hidden="true"></i>',
          },
          { text: "", value: "split", example: "" },
          {
            ...
            value: "filter",
            example:
              '<i class="iconfont luckysheet-iconfont-shaixuan2" aria-hidden="true"></i>',
          },
          {
            text: locale_filter.clearFilter,
            value: "clearfilter",
            example:
              '<i class="iconfont luckysheet-iconfont-qingchushaixuan" aria-hidden="true"></i>',
          },
        ];
      ...
      if ($menuButton.length == 0) {
        let itemdata = [
          ...
          },
          {
            ...
            value: "replace",
            example:
              '<i class="iconfont luckysheet-iconfont-tihuan" aria-hidden="true"></i>',
          },
          ...
          { text: "", value: "split", example: "" },
          {
            ...
            value: "location",
            example:
              '<i class="iconfont luckysheet-iconfont-dingwei" aria-hidden="true"></i>',
          },
          {
          ...
          if (itemvalue == "if") {
            ...
            if (cell != null && cell.f != null) {
              ...
              if (functionStr.fn != null) {
                //有函数公式
                insertFormula.formulaParmDialog(
                  functionStr.fn,
                  functionStr.param
                );
              } else {
    ...
    $("#luckysheet-icon-conditionformat").click(function() {
      ...
      if ($menuButton.length == 0) {
        ...
        $(document)
          ...
          .on(
            "click.CFdataBar",
            "#luckysheet-icon-dataBar-menuButton .luckysheet-cols-menuitem",
            function() {
              $menuButton.hide();
          ...
          .on(
            ...
            function() {
              ...
              if (Store.luckysheet_select_save.length > 0) {
                ...
                let format =
                  conditionformat.colorGradationList[itemvalue]["format"];
        ...
        let itemdata = [
          {
            ...
            value: "print",
            example:
              '<i class="iconfont luckysheet-iconfont-dayin" aria-hidden="true"></i>',
          },
          { text: "", value: "split", example: "" },
          {
          ...
          },
          {
            ...
            value: "rows",
            example:
              '<i class="iconfont luckysheet-iconfont-zhuandao1" aria-hidden="true"></i>',
          },
          {
    ...
    $("body")
      .on(
        ...
        ".luckysheet-menuButton .luckysheet-cols-submenu",
        function(e) {
          let $t = $(this),
  ...
  updateFormat: function(d, attr, foucsStatus) {
    ...
    if (attr in inlineStyleAffectAttribute) {
      if (parseInt($("#luckysheet-input-box").css("top")) > 0) {
        ...
        if (value.substr(0, 1) != "=") {
          let cell =
            d[Store.luckysheetCellUpdate[0]][Store.luckysheetCellUpdate[1]];
          updateInlineStringFormat(
            cell,
            attr,
            foucsStatus,
  ...
  changeMenuButtonDom: function(attr, foucsStatus, _locale) {
    ...
    if (attr == "bl") {
      if (foucsStatus != "0") {
        ...
        $("#luckysheet-icon-bold").removeClass(
          "luckysheet-toolbar-button-hover"
        );
      }
    } else if (attr == "it") {
      if (foucsStatus != "0") {
        $("#luckysheet-icon-italic").addClass(
          "luckysheet-toolbar-button-hover"
        );
      } else {
        $("#luckysheet-icon-italic").removeClass(
          "luckysheet-toolbar-button-hover"
        );
      }
    } else if (attr == "cl") {
      if (foucsStatus != "0") {
        $("#luckysheet-icon-strikethrough").addClass(
          "luckysheet-toolbar-button-hover"
        );
      } else {
        $("#luckysheet-icon-strikethrough").removeClass(
          "luckysheet-toolbar-button-hover"
        );
      }
    } else if (attr == "un") {
      if (foucsStatus != "0") {
        $("#luckysheet-icon-underline").addClass(
          "luckysheet-toolbar-button-hover"
        );
      } else {
        $("#luckysheet-icon-underline").removeClass(
          "luckysheet-toolbar-button-hover"
        );
      }
    } else if (attr == "ff") {
  ...
  mergeMoveMain: function(
    ...
    while (offloop) {
      ...
      for (let i = 0; i < mcset.length; i++) {
        ...
        let changeparam = _this.mergeMove(
          mc,
          columnseleted,
          rowseleted,
          s,
  ...
  autoSelectionFormula: function(formula) {
    ...
    for (let s = 0; s < Store.luckysheet_select_save.length; s++) {
      ...
      if (st_r == ed_r && st_c == ed_c) {
        ...
        isfalse = _this.singleFormulaInput(
          d,
          col_index,
          st_r,
          st_c,
  ...
  getStyleByCell: function(d, r, c) {
    ...
    for (let key in cell) {
      ...
      if (
        checksAF != null ||
        (checksCF != null && checksCF["cellColor"] != null)
      ) {
